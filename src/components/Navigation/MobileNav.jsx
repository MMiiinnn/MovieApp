...
function MobileNav({ isOpenSidebar }) {
  ...
  return (
    <>
      <nav
        className={`flex lg:hidden justify-between items-center w-full px-2 transition-all duration-500 ease-in-out
      ...
      <div
        className={`absolute inset-0 flex items-center gap-2 py-2 px-3 bg-black transition-all duration-500 ease-in-out z-10
